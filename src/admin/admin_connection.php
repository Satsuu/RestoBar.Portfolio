...
$admin_connection = mysqli_connect("localhost", "root", "", "ollies_db");
...
<style>
    ...
    /********************* Shopping Demo-3 **********************/
        ...
        .product-grid3 .product-image3 img{width:100%;height:70%}
        ...
        .product-grid3 .quantity1{padding:0;margin:-22px 0 0;list-style:none;text-align:right;display:block}
