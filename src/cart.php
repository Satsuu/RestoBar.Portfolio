    ...
    <div class="card table-responsive px-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;"><a href="cart.php?remove_product=<?php echo $fetch_cart['menu_id']; ?>" onclick="return confirm('Remove item from cart?')" class="btn btn-custom fw-bold"> <i class="fas fa-trash"></i> Remove</a></td>
                    </tr>
                    <?php
                        $sub_total += $total;  
                        }
                    ...
                    <tr class="table-bottom">
                        <td style="text-align:center;"><a href="menu.php" class="btn btn-custom fw-bold" style="margin-top: 0;">Continue Shopping</a></td>
                    ...
                    <div class="text-center">
                        <a href="checkout.php" class="btn btn-custom fw-bold col-md-3 mb-2 <?= ($total > 1)?'':'disabled'; ?>">Proceed to checkout</a>
                    </div>
            </div>
    </body>
